...
const ImageList = [
  {
    ...
    description:
      "Lorem His Life will forever be Changed dolor sit amet, consectetur adipscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
  },
  {
    id: 1,
    img: Image2,
        ...
        <div>
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            order-2 sm:order-1 relative z-10">
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold">Lorem ipsum dolor sit   1:06 no video</h1>
              <p className="text-sm">
            ...
            <div className="order-1 sm:order-2">
                <div className="relative z-10">
                    <img src={Image1} alt=""
                    className="w-[300px] h-[300px] sm:h-[450] sm:w-[450] sm:scale-125 object-contain mx-auto"
                    />
                </div>
            </div>
          </div>
